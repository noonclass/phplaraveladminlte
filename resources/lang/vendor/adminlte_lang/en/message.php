...
return [
    ...
    */
    ...
    'errormessages'           => ['uploadnofilesfound'=>'没有找到待上传文件。','uploadfault'=>'产生了一个错误，请联系系统管理员。','uploadnofilesproc'=>'产生了一个错误，没有文件被处理。','nameinvalid'=>'用户名长度4-16位，只允许数字/字母/下划线。','emailinvalid'=>'电子邮件格式不正确。','passwordinvalid'=>'密码长度6-16位，只允许数字/字母/下划线。'],
